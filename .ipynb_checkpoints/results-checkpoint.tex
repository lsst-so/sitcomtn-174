...
We perform the measurements using all stars, and we use stars binned by $g-i$ colour in 3 equally distributed bins to quantify the colour-dependent effects. 
...
The stars have been divided into colour bins of $g-i \in [0.66, 0.94, 1.78, 3.5]$. 
\begin{figure}[h!]
  \centering
  ...
  Note that the y-axis ranges in (a) and (b) are different. Stars are divided into equal-sized colour bins of $g-i \in [0.66, 0.94, 1.78, 3.5]$. 
...
\begin{figure}[h!]
  ...
  Note that the y-axis ranges in (a) and (b) are different. Stars are divided into equal-sized colour bins of $g-i \in [0.65, 0.87, 1.39, 3.5]$. 
...
The stars are divided into colour bins of $g-i \in [0.65, 0.87, 1.39, 3.5]$. 
...
Subfig.~\ref{subfig:color_vs_residuals_c} shows the number density of stars as a function of $g-i$ colour, which is common to both subfigures~\ref{subfig:color_vs_residuals_a}. and \ref{subfig:color_vs_residuals_b}.
...
The stars are separated in colour bins of $g-i \in [0.64, 0.85, 1.5, 3.5]$.
...
\begin{figure}[h!]
 ...
 \begin{subfigure}{\textwidth}
    ...
    \caption{Distribution of $\tan^2{z}$ in $g$ band.}
    \label{subfig:dcr_altaz_vs_residuals_c}
  \end{subfigure}
  \caption{Residuals (in Alt/Az coordinates) vs. $\tan^2{z}$ in g-band. The leftmost panel shows the trace residual $\delta T$, and the other two panels show residuals defined in Eq.~\ref{eq:altaz_residuals}. 
  Chromatic fitting reduces residuals by almost an order of magnitude.}
  \label{fig:dcr_g_altaz}
\end{figure}

Figure~\ref{fig:dcr_g_altaz} shows residuals vs. $\tan^2{z}$ in $g$ band. 
